package com.habuma.spitter.dao.impl;
...
public class UserDetailsDaoImpl extends JdbcDaoSupport implements
    ...
    private static final String SQL_USER_ATTEMPTS_GET = "SELECT d_id id,d_username username,d_attempts attempts,d_lastmodified lastmodified FROM t_user_attempts2 WHERE d_username = ?";
    private static final String SQL_USER_ATTEMPTS_INSERT = "INSERT INTO t_user_attempts2 (d_username, d_attempts, d_lastmodified) VALUES(?,?,?)";
    private static final String SQL_USER_ATTEMPTS_UPDATE_ATTEMPTS = "UPDATE t_user_attempts2 SET d_attempts = d_attempts + 1, d_lastmodified = ? WHERE d_username = ?";
    private static final String SQL_USER_ATTEMPTS_RESET_ATTEMPTS = "UPDATE t_user_attempts2 SET d_attempts = 0, d_lastmodified = null WHERE d_username = ?";
